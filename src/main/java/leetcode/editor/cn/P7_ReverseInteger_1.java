...
public class P7_ReverseInteger_1 {
	public static void main(String[] args) {
		//测试代码
		Solution solution = new P7_ReverseInteger_1().new Solution();
	...
	class Solution {
		 ...
		 * 解法二，优化解法 思路：
		 * 1.整数转字符串，再转字符数组
		 * 2.交换首位（start）和末位（end）
		 * 3.循环操作：依次交换第二（start++）和倒数第二个（end--），直到数组剩下一个或零个元素
		 * 4.将元素组转成字符串，再转成整数输出
		 *
		 * 注意事项：
		 * 边界问题
